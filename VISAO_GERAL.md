...
|------------|------------------|
| **Plataforma administrativa** | Autenticação, CRUD de conteúdos, configuração de telas/navegação/banners |
| **Hub Karmaleões (público)** | Exibição de conteúdos configurados, links externos |
...
- **Módulos 2–6:** create, update e delete de entidades configuráveis
...
- Usuários administrativos são identificados por e-mail.
...
```
Autenticação (1)
    └── protege acesso aos módulos 2–6
